%#################### 9.1 ####################
\subsection{LaTeX Coffee Stains}
\begin{table}[h!]
\begin{tabular}{c | c}
...
\clearpage
%#################### 9.3 ####################
\subsection{\fadingtext[scale=1, font=\bfseries]{path picture shading=rainbow}{Rainbow text}}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
\end{table}
%#################### 9.5 #################### 
\subsection{Full page of Watermarks}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
\end{table}
%#################### 9.9 ####################
\subsection{Watermark over \textbf{everything}}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
