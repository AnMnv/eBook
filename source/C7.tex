...
\end{document}
	...
	%#################### 7.2 ####################
\subsection{Circled arrows with text}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{ 
...
\end{table}
%#################### 7.5 ####################
\subsection{Round levels of skills }
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
\newpage
%#################### 7.7 ####################
\subsection{Aligning anything to a corer}
