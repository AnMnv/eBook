%#################### 8.1 ####################
\subsection{Words highlighting \xmybox{1}}
\begin{table}[h!]
\begin{tabular}{c | c}
...
\end{table}
%#################### 8.2 ####################
\subsection{Unusual words highlighting}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{
...
%#################### 8.5 ####################
\subsection{Circle text in points to other text}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 8.7 ####################
\subsection{Colorful \xmyboxg{$\backslash$tableofcontents}}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{Press \button{alt } + \button{F4 } for help !}{8.6}
