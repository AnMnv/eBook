%-------------------------------------------- 6.1  
\subsection{Numbering in few columns}
\begin{table}[h!]
\begin{tabular}{c | c}
...
%-------------------------------------------- 6.2
\subsection{Enumeration environment with position number in the format (i, j)}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
\newpage
%-------------------------------------------- 6.3  
\subsection{Colored enumeration}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
\end{table}
%-------------------------------------------- 6.4  
\subsection{Leveled arabic enumeration}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{\includegraphics[width=0.9\linewidth]{6.4.png}}{6.4}
\end{minipage}
&
\begin{minipage}[m]{0.55\textwidth}
\renewcommand\textminus{\mbox{-}}%<<<<<<<<<<<
...
\end{table}
%-------------------------------------------- 6.5 
\subsection{Change footnote symbol}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{\includegraphics[width=0.9\linewidth]{6.5.png}}{6.5}
\end{minipage}
&
\begin{minipage}[m]{0.55\textwidth}
\renewcommand\textminus{\mbox{-}}%<<<<<<<<<<<
