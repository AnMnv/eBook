...
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{\href{https://ctan.org/pkg/bclogo}{\img{1}{../images/4.5/4.5.pdf}}}{\thesubsection}
\end{minipage}
&
\begin{minipage}[m]{0.55\textwidth}
\renewcommand\textminus{\mbox{-}}%<<<<<<<<<<<
...
%#################### 4.8 ####################
\subsection{\hll{Absolutely centered cells (vertically and horizontally)}}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{
\makegapedcells
...
\end{tabular}
%#################### 4.21 ####################
\subsection{\hll{Table with rounded corners}}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{\href{https://tex.stackexchange.com/questions/10224/table-with-rounded-corners}{\img{1}{4.21.pdf}}}{\thesubsection}
\end{minipage}
&
\begin{minipage}[m]{0.55\textwidth}
\renewcommand\textminus{\mbox{-}}%<<<<<<<<<<<
...
ST & Mark Viduka \\
\hline
\multicolumn{2}{c}{\cellcolor{tablecolor}\color{white} Substitutes} \\ \hline
GK & Nigel Martyn \\
DF & Danny Mills \\
MF & Jason Wilcox \\
MF & Olivier Dacourt \\
FW & Robbie Keane \\
\hline
\multicolumn{2}{c}{\cellcolor{tablecolor}\color{white} Coaching Staff} \\ \hline
Manager & David O'Leary \\
Assistant Manager & Eddie Gray \\
Fitness Coach & Dean Riddle \\
Goalkeeping Coach & Andy Rhodes \\
Physiotherapist & Dave Hancock \\
\end{rndtable}
\end{document}
\end{lstlisting}
\end{minipage}
