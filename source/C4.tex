...
%#################### 4.2 ####################
\subsection{Color box with yellow border}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 4.3 ####################
\subsection{A drop capital in a tcolorbox}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 4.4 ####################
\subsection{\textit{Table with the desired length. }}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{
...
%#################### 4.6 ####################
\subsection{bclogo – Creating colourful boxes with logos}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 4.8 ####################
\subsection{Absolutely centered cells (vertically and horisontally)}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{
...
%#################### 4.9 ####################
\subsection{Martix made of table}
\begin{tabular}{c | c}
...
%#################### 4.10 ####################
\subsection{Centering cells with \xmybox{NiceTabular}}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 4.11 ####################
\subsection{Centered cells in \xmybox{longtable}}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 4.12 ####################
\subsection{If table is not wide enough}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{ 
...
%#################### 4.13 ####################
\subsection{Text next to a table}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%#################### 4.14 ####################
\subsection{Hand Drawn tcolorbox}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
...
%---
 \end{tikzpicture} 
  \href{https://tex.stackexchange.com/questions/154842/using-pattern-inside-tikz-shapes-with-dropped-shadows}{*****} }{4.15}
\end{minipage}
&
\begin{minipage}[m]{0.55\textwidth}
\renewcommand\textminus{\mbox{-}}%<<<<<<<<<<<
...
\subsection{Halfframed boxes}
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{\includegraphics[width=1\linewidth]{4.16.png}}{4.16}
\end{minipage}
&
\begin{minipage}[m]{0.55\textwidth}
\renewcommand\textminus{\mbox{-}}%<<<<<<<<<<<
