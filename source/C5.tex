...
%-------------------5.3
\subsection{Placing image \xmybox[red!70!white]{anywhere} You want}
\begin{table}[ht!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{
...
%-------------------5.4
{\subsection{Italic sabfigure references}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{  \centering
...
\end{table}
 %-------------------5.6
 \subsection{Figures in landscape mode}
\begin{table}[h!]
\begin{tabular}{c | c}
\begin{minipage}[m]{0.4\textwidth}
\enum{ 
